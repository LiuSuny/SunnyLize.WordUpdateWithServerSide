    ...
    public partial class TextEntryControl : UserControl
    {
        ...
        public static readonly DependencyProperty LabelWidthProperty =
            DependencyProperty.Register("LabelWidth", typeof(GridLength), 
                typeof(TextEntryControl), new PropertyMetadata(GridLength.Auto, LabelWidthChangeCallBack));
         ...
         private static void LabelWidthChangeCallBack(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            try
            {
                ...
                (d as TextEntryControl).LabelColumnDefintion.Width = ((GridLength)e.NewValue);
            ...
            catch(Exception)
            {
                ...
                (d as TextEntryControl).LabelColumnDefintion.Width = GridLength.Auto;
            }
        }
        #endregion
    }
